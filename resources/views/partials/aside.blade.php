                                    ...
                                    class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg
                                 	...
                                 	<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											...
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{ route('unit.index') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Units</span><span class="kt-menu__link-badge"></span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="{{ route('supplier.index') }}" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--line"><span></span></i><span class="kt-menu__link-text">Supplier</span><span class="kt-menu__link-badge"></span></a></li>
										</ul>
									</div>
                    </div>
